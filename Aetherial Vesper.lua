...
do
    ...
    do
        ...
        l_v477_3.color = l_v478_1:color_picker("Color", color(255, 0, 0, 255));
        v458(l_v477_3.style, {
            [1] = "Branded"
        });
...
l_angles_0 = {};
v982 = string.format("%s\a%%s.RED", string.upper(v13.name));
...
do
    ...
    v1532 = string.format("\a%%s%s\a%%s.red", string.lower(v13.name));
